...
ASCIITESTOBJ := test/test_ascii_histogram
...
$(ASCIITESTOBJ): test/test_ascii_histogram.c
	$(CC) $(CFLAGS) test/test_ascii_histogram.c -o $@

test: $(TESTOBJ) $(HDRTESTOBJ) $(PENDINGMAPTESTOBJ) $(ASCIITESTOBJ)
	...
	@./$(PENDINGMAPTESTOBJ)
	@echo ""
	@echo "Running ASCII histogram visualization test..."
	@./$(ASCIITESTOBJ)
...
clean:
	rm -f $(BPFOBJ) $(SKEL) $(USEROBJ) $(USEROBJ)-static $(TESTOBJ) $(HDRTESTOBJ) $(PENDINGMAPTESTOBJ) $(ASCIITESTOBJ)
